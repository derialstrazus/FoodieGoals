...
interface JQuery {
    ...
    /**
     * Similar to hover, but added to work with the hoverIntent plugin
     * @param handlerIn
     * @param handlerOut
     */
    hoverIntent(handlerIn: (eventObject: JQueryEventObject) => any, handlerOut: (eventObject: JQueryEventObject) => any): JQuery;
